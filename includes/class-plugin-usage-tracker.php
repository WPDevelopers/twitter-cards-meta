...
/**
 * Main SDK for Twcm_Plugin_Usage_Tracker.
 */
if( ! class_exists('Twcm_Plugin_Usage_Tracker') ) :
	class Twcm_Plugin_Usage_Tracker {
		...
		/**
		 * Instace of Twcm_Plugin_Usage_Tracker
		 * @var Twcm_Plugin_Usage_Tracker
		 */
		private static $_instance = null;
		/**
		 * Get Instance of Twcm_Plugin_Usage_Tracker
		 * @return Twcm_Plugin_Usage_Tracker
		 */
